...
class selectWidget
{
  ...
  var $netlib = Array(
   ...
   "ILCOCORAHS" => "Illinois CoCoRaHS",
   "COOPDB" =>"Iowa Climate Sites",
   "ISUAG" =>"ISU Ag Climate",
   "IA_ASOS" => "Iowa ASOS",
   "AWOS" => "Iowa AWOS",
   "NSTLFLUX" => "NSTL Flux Sites",
   "IA_RWIS" => "Iowa RWIS",
   "DCP" => "Iowa DCP Sites",
   ...
   "IL_COOP" => "Illinois COOP",
   "IN_ASOS" => "Indiana ASOS",
   "IN_COOP" => "Indiana COOP",
   "KS_ASOS" => "Kansas ASOS",
   "KS_COOP" => "Kansas COOP",
   "MI_ASOS" => "Michigan ASOS",
   "MI_COOP" => "Michigan COOP",
   "MN_ASOS" => "Minnesota ASOS",
   "MN_AWOS" => "Minnesota AWOS",
   "MN_COOP" => "Minnesota COOP",
   "MO_ASOS" => "Missouri ASOS",
   "MO_COOP" => "Missouri COOP",
   "ND_ASOS" => "North Dakota ASOS",
   "ND_COOP" => "North Dakota COOP",
   "ND_RWIS" => "North Dakota RWIS",
   "NE_ASOS" => "Nebraska ASOS",
   "NE_COOP" => "Nebraska COOP",
   "NE_RWIS" => "Nebraska RWIS",
   "OH_ASOS" => "Ohio ASOS",
   "OH_COOP" => "Ohio COOP",
   "OH_RWIS" => "Ohio RWIS",
  ...
  var $presets = Array(
   ...
   "NSTLFLUX" => Array(175000, 4400000, 775000, 4850000),
   ...
   "WI_COOP" => Array(575000, 4700000, 1175000, 5150000),
   ...
   "ILCOCORAHS" => Array(620917, 4063582, 990083, 4750925),
   "IL_COOP" => Array(620917, 4063582, 990083, 4750925),
   "IN_ASOS" => Array(940979, 4185564, 1189029, 4688185),
   "IN_COOP" => Array(940979, 4185564, 1189029, 4688185),
   "KS_ASOS" => Array(-332765, 4092099, 391358, 4419242),
   "KS_COOP" => Array(-332765, 4092099, 391358, 4419242),
   "MI_ASOS" => Array(699532, 4583808, 1329337, 5270880),
   "MI_COOP" => Array(699532, 4583808, 1329337, 5270880),
   "MN_ASOS" => Array(110000, 4700000, 775000, 5500000),
   "MN_AWOS" => Array(110000, 4700000, 775000, 5500000),
   "MN_COOP" => Array(110000, 4700000, 775000, 5500000),
   "MO_ASOS" => Array(288643, 4031077, 830891, 4501118),
   "MO_COOP" => Array(288643, 4031077, 830891, 4501118),
   "NE_ASOS" => Array(-443050, 4449533, 309260, 4789607),
   "NE_COOP" => Array(-443050, 4449533, 309260, 4789607),
   "NE_RWIS" => Array(-443050, 4449533, 309260, 4789607),
   "ND_ASOS" => Array(-372922, 5109273,268869, 5409961),
   "ND_COOP" => Array(-372922, 5109273,268869, 5409961),
   "ND_RWIS" => Array(-372922, 5109273,268869, 5409961),
   "OH_ASOS" => Array(1193810, 4322261, 1565503, 4739477),
   "OH_COOP" => Array(1193810, 4322261, 1565503, 4739477),
   "OH_RWIS" => Array(1193810, 4322261, 1565503, 4739477),
