...
if ($row["voting"] == "f"){
	...
	define("FBEXTRA", True);
	$s .= "<fb:comments send_notification_uid=\"16922938\"  title=\"". $row["title"] ."\" \" href=\"https://mesonet.agron.iastate.edu/onsite/features/cat.php?day=". $row["permalink"] ."\" xid=\"$fbid\" numposts=\"6\" width=\"520\"></fb:comments>";
