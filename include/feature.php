...
if ($row["voting"] == "f"){
	...
	define("FBEXTRA", "<script src=\"http://connect.facebook.net/en_US/all.js#appId=196492870363354&amp;xfbml=1\"></script>");
	$s .= "<fb:comments send_notification_uid=\"16922938\" callback=\"$rooturl/fbcb.php\" title=\"". $row["title"] ."\" \" href=\"$rooturl/onsite/features/cat.php?day=". $row["permalink"] ."\" xid=\"$fbid\" numposts=\"6\" width=\"520\"></fb:comments>";
