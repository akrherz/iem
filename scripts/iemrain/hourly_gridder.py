...
def do(ts):
    ...
    while now <= ts1:
        ...
        d = numpy.flipud( n0rd[y1:y0,x0:x1] )
        reflect[i,:,:] = ( d - 5.0) * 5.0 # convert to dBZ
    ...
    raw_rates = numpy.power(numpy.power(10.0,(reflect/10.0)) / 300.0 , 1.0/1.4) / 12.0  # For a 5min period
...
do(mx.DateTime.DateTime(2009,9,3,9,0))
