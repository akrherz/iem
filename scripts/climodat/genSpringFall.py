...
""" % (station, base))
    ...
    smean = sjdaytot / yrs
    emean = ejdaytot / yrs
    sts = mx.DateTime.DateTime(2001, 1,
                               1) + mx.DateTime.RelativeDateTime(days=smean)
    ets = mx.DateTime.DateTime(2001, 1,
                               1) + mx.DateTime.RelativeDateTime(days=emean)
