...
opts = {
        ...
        'edate': datetime.date(1995, 1, 1),
        'normalized': True,
        'dbcols': ('TO','SV','FF'),
        }
opts['title'] = "Yearly Average Number of Tornado, SVR, + Flash Flood Warnings"
opts['years'] = float(opts['edate'].year - opts['sdate'].year)
opts['units'] = 'count per year'
...
if opts['normalized']:
    opts['subtitle'] += " (Normalized by County Size)"
    opts['units'] += " / sq km"
    bins = [0.0001, 0.0002, 0.0005, 0.0007, 0.001, 0.0015, 0.002, 0.006,  0.01, 0.012, 0.015, 0.02, 0.025]
