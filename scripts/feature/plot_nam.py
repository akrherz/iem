...
grib = Nio.open_file('/home/akrherz/Downloads/nam.t00z.conusnest.hiresf00.tm00.grib2', 'r')
lats = grib.variables['gridlat_0'][:]
lons = grib.variables['gridlon_0'][:]
...
# 'cnFillMode'		: 'CellFill',
 ...
 '_title'             : "NAM Surface Based Convective Available Potential Energy (CAPE)",
 '_valid'             : "%s Analysis for %s" % (
      ts0.strftime("%-I %p %-d %B %Y"), ts.strftime("%-I %p %-d %B %Y")),
 'lbTitleString'      : "J/kg",
 '_midwest'		: True,
}
# Generates tmp.ps
tmpfp = iemplot.simple_grid_fill(lons, lats, CAPE, cfg)
import iemplot
