...
bars = ax.bar([0.2, 1.2, 2.2],
              [rise_hits / rise_cases * 2.0, set_hits / set_cases * 2.0,
               0.246 * 2], width=0.6, zorder=3)
for i, bar in enumerate(bars):
    txt = ax.text(i+0.5, bar.get_height()+0.05,
                  "%.1f%%" % (bar.get_height() / 2.0 * 100.0,), zorder=4,
