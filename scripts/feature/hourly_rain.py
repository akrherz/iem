...
icursor.execute("""
 ...
 where valid < '2013-01-01' and extract(month from valid) in (5) 
...
icursor.execute("""
 ...
 where  extract(month from valid) in (5) 
...
ax.set_xlabel("2013 Total thru 27 May")
ax.set_ylabel("Precipitation [inch]")
ax.set_title("Des Moines May Hourly Precipitation")
