...
ets = mx.DateTime.DateTime(2012,3,29)
...
while now < ets:
  ...
  and month in (1,2,3) and day > '1893-11-30'
  and sday <= '%s' 
...
bars = ax2.bar( np.arange(1,len(percentile)+1) -0.4, departure )
for i in range(-1,0):
