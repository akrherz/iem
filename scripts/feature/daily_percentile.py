...
ets = mx.DateTime.DateTime(2012,1,31)
...
while now < ets:
  ...
  and month in (12,1) and day > '1893-11-30'
  ...
  for row in ccursor:
    ...
    if row[0] == 2012:
      break
  print now, float(cnt) / 119.0 * 100.0
