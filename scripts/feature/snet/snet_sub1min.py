...
pday = []
lines = []
now = mx.DateTime.DateTime(2013, 6, 23, 0, 0)
txt2drct = {
 'N': '360',
 'North': '360',
 'NNE': '25',
...
for line in open('farmhamville.txt'):
...
sts = mx.DateTime.DateTime(2013, 6, 23, 8, 45)
ets = mx.DateTime.DateTime(2013, 6, 23, 9, 46)
...
ax[1].grid(True)
ax[2].grid(True)
ax[0].set_title("Farnhamville SchoolNet8 Site (~ $\Delta$6 second data)")
ax[2].set_xlabel("Morning of 23 Jun 2013")
