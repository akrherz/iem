...
csh -c "(mergelog access_log.iemvs* > access.log) >& /dev/null"
wc -l access_log.iemvs* 
rm -f access_log.iemvs*

csh -c "(mergelog access_log-wepp.iemvs* > wepp_access.log) >& /dev/null"
wc -l access_log-wepp.iemvs* 
rm -f access_log-wepp.iemvs*

csh -c "(mergelog access_log-idep.iemvs* > idep_access.log) >& /dev/null"
wc -l access_log-idep.iemvs* 
rm -f access_log-idep.iemvs*

csh -c "(mergelog access_log-cocorahs.iemvs* > cocorahs_access.log) >& /dev/null"
wc -l access_log-cocorahs.iemvs*
rm -f access_log-cocorahs.iemvs*

csh -c "(mergelog access_log-sustainablecorn.iemvs* > sustainablecorn_access.log) >& /dev/null"
