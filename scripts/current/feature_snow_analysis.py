...
icursor.execute("""
    ...
    day in ('2014-01-19', '2014-01-19') and snow >= 0 and 
...
pcursor.execute("""
    SELECT state, max(magnitude) as val, 
      ...
      valid > '2014-01-28 06:00' and valid < '2014-01-31 23:59'
...
m = MapPlot(sector='iowa',
            title="18 Jan 2014 - IEM Snowfall Total Analysis",
            subtitle="Snowfall totals up until 8 AM 19 Jan 2014")
