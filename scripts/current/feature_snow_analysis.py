...
icursor.execute("""
    ...
    day in ('2013-11-21', '2013-11-22') and snow >= 0 and 
...
pcursor.execute("""
    SELECT state, max(magnitude) as val, 
      ...
      valid > '2013-11-21 00:00' and valid < '2013-11-22 23:59'
...
cfg = {
 ...
 'nglSpreadColorEnd'  : -1,
 '_title'             : "21-22 Nov 2013 - IEM Snowfall Total Analysis",
 '_valid'             : "Snowfall totals up until 8 AM 23 Nov 2013",
 #'_MaskZero'          : True,
 'lbTitleString'      : "[in]",
  '_showvalues'        : False,
