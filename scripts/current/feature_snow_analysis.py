...
icursor.execute("""
    ...
    day in ('2013-12-11', '2013-12-11') and snow >= 0 and 
...
pcursor.execute("""
    SELECT state, max(magnitude) as val, 
      ...
      valid > '2013-12-11 00:00' and valid < '2013-12-26 23:59'
...
cfg = {
 ...
 'nglSpreadColorEnd'  : -1,
 '_title'             : "10-11 Dec 2013 - IEM Snowfall Total Analysis",
 '_valid'             : "Snowfall totals up until 8 AM 11 Dec 2013",
 #'_MaskZero'          : True,
 'lbTitleString'      : "[in]",
  '_showvalues'        : False,
