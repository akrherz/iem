...
rs = iemdb.query("SELECT station from summary WHERE network = 'IACOCORAHS' and \
  day = 'TODAY' ORDER by snow DESC").dictresult()
dict = {}
...
<element type="Image" name="E:\live\content\images\overlays\\banners\\snowfall.tif" noimage="0" updatable="0" duration="5" elementname="" />
...
os.system("/home/ldm/bin/pqinsert coco_top5snow.scn")
os.remove("coco_top5snow.scn")
