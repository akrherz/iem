...
function drawRADAR($site, $imgi, $extents, $projs, $radValid, $fips){
  ...
  $radarL = $map->getlayerbyname($site);
  $radarL->set("status", MS_ON);
//  if ($site == "DMX"){
 //   $radarL->set("data", "/mesonet/data/gis/images/26915/DMX/DMX_N0R_".$imgi.".png");
 // } else{
    $radarL->set("data", "/mesonet/data/gis/images/unproj/". $site ."/n0r_".$imgi.".tif");
//  }
