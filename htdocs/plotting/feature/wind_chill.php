...
$sql = "SELECT extract(EPOCH from valid) as epoch, tmpf, dwpf, sknt, vsby
  , wind_chill(tmpf, sknt) as wcht from t2009 WHERE station = 'CKP' 
  and dwpf > -99 and sknt >= 0 and valid > '2009-12-28' ORDER by valid ASC";
...
$graph = new Graph(620,400,"example1");
...
$lineplot=new LinePlot($wcht, $times);
