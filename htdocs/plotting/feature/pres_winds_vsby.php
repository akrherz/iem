...
$sql = "SELECT extract(EPOCH from valid) as epoch, tmpf, dwpf, sknt, vsby
  , wind_chill(tmpf, sknt) as wcht, alti from t2009 WHERE station = 'DSM' 
  and dwpf > -99 and sknt >= 0 and valid > '2009-12-08' ORDER by valid ASC";
...
$graph->img->SetMargin(50,45,50,80);
