...
def get_description():
    ...
    desc = dict()
    desc['data'] = True
    desc['description'] = """This application presents daily comparisons of an
    ...
    desc['arguments'] = [
        ...
        dict(type='hour', name='h1', default=6,
             label='First Hour:'),
        dict(type='hour', name='h2', default=18,
             label='Second (subsequent) Hour:'),
        dict(type='year', name='y1', default=datetime.date.today().year,
             label='Year to highlight in chart:'),
        dict(type='year', name='y2', default=datetime.date.today().year,
             label='Additional Year to plot (optional):', optional=True),
        dict(type='year', name='y3', default=datetime.date.today().year,
             label='Additional Year to plot (optional)', optional=True),
        dict(type='year', name='y4', default=datetime.date.today().year,
             label='Additional Year to plot (optional)', optional=True),
