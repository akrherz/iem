...
data = {
    "plots": [
        {"label": "Daily", "options": daily_opts},
        {
            ...
            "options": [
                ...
                },
                {
                    "id": "42",
                    "label": (
                        "Hourly Temperature Streaks Above/Below Threshold"
                    ),
                },
        ...
        },
        {
            ...
            "options": [
                ...
                },
                {
                    "id": "151",
                    "label": (
                        "Difference between two periods or "
                ...
                {
                    "id": "99",
                    "label": "Daily High + Low Temperatures with Departures",
                },
                {
                    "id": "12",
                    "label": (
                ...
                },
                {
                    "id": "181",
                    "label": (
                        "Days per year with temp/precip/snowfall "
                        "within ranges"
                    ),
                },
                {
                ...
                {
                    "id": "165",
                    "label": "First / Last Date of Temperature Threshold [map]",
                },
                {
                    "id": "119",
                ...
                },
                {
                    "id": "152",
                    "label": (
                        "Growing Season Differences Map between " "Two Periods"
                    ),
                },
                {
                    "id": "148",
                ...
                },
                {
                    "id": "53",
                    "label": (
                        "Hourly Frequency of Temperature within "
                        "Certain Ranges"
                    ),
                },
                {
                    "id": "10",
                    "label": (
                        "Last Spring and First Fall Date "
                        "above/below given threshold"
                    ),
                },
                {
                ...
                {
                    "id": "44",
                    "label": "NWS Office Accumulated SVR+TOR Warnings",
                },
                {
                    "id": "69",
        ...
        {
            "label": "Hydrology / Drought Monitor Plots",
            "options": [
                {
                    "id": "160",
                    "label": (
                        "River Guage Obs and Forecasts from HML Products"
                    ),
                },
                ...
                },
                {
                    "id": "186",
                    "label": (
                        "US Drought Monitor Change in Areal Coverage by State"
                    ),
                },
                {
                    "id": "194",
                    "label": (
                        "US Drought Monitor Time Duration over Period Maps"
                    ),
                },
                {
                    "id": "193",
                    "label": (
                        "US Drought Monitor + Weather Prediction Center "
                        "Forecasted Rain"
                    ),
                },
            ],
        ...
        {
            "label": "METAR ASOS Special Plots",
            "options": [
                {
                    "id": "78",
                    "label": (
                ...
                },
                {
                    "id": "40",
                    "label": (
                        "Cloud Amount and Level Timeseries / Visibility "
                        "for One Month"
                    ),
                },
                {
                ...
                },
                {
                    "id": "87",
                    "label": (
                        "Frequency of METAR Code (Thunder, etc) "
                ...
                {
                    "id": "45",
                    "label": "Monthly Frequency of Overcast Conditions",
                },
                {
                    "id": "170",
                ...
                {
                    "id": "16",
                    "label": "Wind Rose when specified criterion is meet",
                },
            ],
        },
        {
            "label": "NASS Quickstats (USDA Crop Statistics)",
            "options": [
                {
                    "id": "156",
        ...
        },
        {
            ...
            "options": [
                ...
                },
                {
                    "id": "50",
                    "label": (
                        "Frequency of Hail/Wind Tags used in "
                ...
                },
                {
                    "id": "171",
                    "label": (
                        "Number of Watch/Warning/Advisories Issued "
                        "per Year per Month"
                    ),
                },
                {
                ...
                {
                    "id": "203",
                    "label": "Storm Based Warning Polygon Visual Summary",
                },
                {
                    "id": "195",
                ...
                {
                    "id": "56",
                    "label": "Weekly Frequency of a Watch/Warning/Advisory",
                },
                {
                    "id": "109",
                    "label": (
        ...
        {
            "label": "Upper Air / RAOB Sounding Plots",
            "options": [
                {
                    "id": "198",
                    "label": (
