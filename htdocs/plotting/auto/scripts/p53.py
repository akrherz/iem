...
def plotter( fdict ):
    ...
    ax.bar(weeks, d5, width=1, fc='tan', ec='None', label='%s-%s' % (t4,t5-1))
    ax.bar(weeks, d4,  width=1, fc='yellow', ec='None', label='%s-%s' % (t3,t4-1))
    ax.bar(weeks, d3,  width=1, fc='green', ec='None', label='%s-%s' % (t2,t3-1))
    ax.bar(weeks, d2, width=1, fc='blue', ec='None', label='%s-%s' % (t1,t2-1))
