...
include ("../jpgraph-1.13/jpgraph.php");
include ("../jpgraph-1.13/jpgraph_line.php");
include ("../jpgraph-1.13/jpgraph_bar.php");
...
$graph->title->Set( $cities[$station]["city"] ." [$station] Growing Degree Days (base=50)");
