<?php
$connection = pg_connect("10.10.10.10","5432","coop");


$query2 = "SELECT max_".$data." as max, min_".$data." as min, ".$data." as avg, years, to_char(valid, 'mm dd') as valid from climate WHERE station = '". $station1 ."' ORDER by valid ASC";
