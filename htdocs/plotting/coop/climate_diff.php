...
$query2 = "SELECT high, low, years, to_char(valid, 'mm dd') as valid from climate WHERE station = '". $station1 ."' ORDER by valid ASC";
$query3 = "SELECT high, low, years, to_char(valid, 'mm dd') as valid from climate WHERE station = '". $station2 ."' ORDER by valid ASC";
...
$graph->title->Set("Climatological Comparison");
$graph->subtitle->Set("Climate Record: ".$cities[$station1]["city"] 
  ." " . $years_s1 ." yrs  ".$cities[$station2]["city"] ." " . $years_s2 ." yrs ");
...
$lineplot->SetLegend($cities[$station1]["city"] ." High (F)");
...
$lineplot3->SetLegend($cities[$station2]["city"] ." High (F)");
