<?php 
	$TITLE = "IEM | 48 Hour Difference Plots";
include("/mesonet/php/include/header.php"); 
	include("../../include/imagemaps.php");
?>

<div class="text">
Back to <a href="/plotting/index.php">Interactive Plotting</a>.<p>

This program will create a difference plot between two stations.
The variable for station2 will be substracted from station1. So a positive value
means that station1's value is higher.
