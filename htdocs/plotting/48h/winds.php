...
$query2 = "SELECT sknt, drct, to_char(valid, 'mmdd/HH24MI') as valid from t2002 WHERE station = '". $station ."' 
	and to_char(valid, 'MI') = '00' and valid + '2 day' > CURRENT_TIMESTAMP ORDER by valid ASC LIMIT 48";
...
$graph = new Graph(550,350,"example1");
