...
$tableName1 = strlen($station1) == 3 ? "t2003" : "rtransfer";
$tableName2 = strlen($station2) == 3 ? "t2003" : "rtransfer";
...
$query2 = "SELECT t1.". $data ." as t1_data, t2.". $data ." as t2_data, to_char(t1.valid, 'yymmdd/HH24MI') as 
	...
	and t1.valid + '2 day' > '2003-11-05' and t1.". $data ." > -1 and t2.". $data ." > -1 ORDER by t1.valid DESC LIMIT 72";
