...
def produce_content():
    ...
    res =  "Title: Iowa DOT Trucks\n"
    res += "Refresh: 5\n"
    res += "Color: 200 200 255\n"
    res += "IconFile: 1, 18, 32, 2, 31, \"http://www.tornadocentral.com/grlevel3/windbarbs.png\"\n"
    res += "IconFile: 2, 15, 15, 8, 8, \"http://www.tornadocentral.com/grlevel3/cloudcover.png\"\n" 
    res += "IconFile: 3, 15, 25, 8, 25, \"http://www.spotternetwork.org/icon/arrows.png\"\n"
    res += "Font: 1, 11, 1, \"Courier New\"\n\n"
    ...
    where valid > (now() - '1 hour'::interval) ORDER by label ASC""")
