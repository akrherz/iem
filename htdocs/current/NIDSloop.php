...
theImages[0].src = "<?php echo($site . "_". $product); ?>_9.gif";
imageNum[0] = true;
...
HEIGHT=24 SRC="http://www.pals.iastate.edu/icons/nrm_button.gif" ALT="Normal"></A>
                      <A HREF="JavaScript: func()" onClick="sweep()"><IMG BORDER=0 WIDTH=29 HEIGHT=24
SRC="http://www.pals.iastate.edu/icons/swp_button.gif" ALT="Sweep"></A><BR> 
        <HR WIDTH="70%" SIZE=2>
                      
        <FONT SIZE=-1 COLOR="#3300CC">Animate Frames:</FONT><BR>
                      <A HREF="JavaScript: func()" onClick="change_mode(1);rev()"><IMG BORDER=0 WIDTH=35
HEIGHT=35 SRC="http://www.pals.iastate.edu/icons/rev_button.gif" ALT="REV"></A>
                      <A HREF="JavaScript: func()" onClick="stop()"><IMG BORDER=0 WIDTH=35 HEIGHT=35
SRC="http://www.pals.iastate.edu/icons/stp_button.gif" ALT="STOP"></A>
                      <A HREF="JavaScript: func()" onClick="change_mode(1);fwd()"><IMG BORDER=0 WIDTH=35
HEIGHT=35 SRC="http://www.pals.iastate.edu/icons/fwd_button.gif" ALT="FWD"></A><BR> 
        <HR WIDTH="70%" SIZE=2>

        <FONT SIZE=-1 COLOR="#3300CC"> Dwell First:</FONT><BR>
                      <A HREF="JavaScript: func()" onClick="change_start_dwell(-dwell_step)"><IMG BORDER=0
WIDTH=29 HEIGHT=24 SRC="http://www.pals.iastate.edu/icons/dw1_minus.gif" ALT="dec"></A>
                      <A HREF="JavaScript: func()" onClick="change_start_dwell(dwell_step)"><IMG BORDER=0
WIDTH=29 HEIGHT=24 SRC="http://www.pals.iastate.edu/icons/dw1_plus.gif" ALT="inc"></A><BR>

        <FONT SIZE=-1 COLOR="#3300CC"> Dwell Last:</FONT><BR>
                      <A HREF="JavaScript: func()" onClick="change_end_dwell(-dwell_step)"><IMG BORDER=0
WIDTH=29 HEIGHT=24 SRC="http://www.pals.iastate.edu/icons/dw2_minus.gif" ALT="dec"></A>
                      <A HREF="JavaScript: func()" onClick="change_end_dwell(dwell_step)"><IMG BORDER=0
WIDTH=29 HEIGHT=24 SRC="http://www.pals.iastate.edu/icons/dw2_plus.gif" ALT="inc"></A><BR> 
        <HR WIDTH="70%" SIZE=2>
...
HEIGHT=35 SRC="http://www.pals.iastate.edu/icons/slw_button.gif" ALT="--"></A>
                      <A HREF="JavaScript: func()" onClick="change_speed(-delay_step)"><IMG BORDER=0 WIDTH=35
HEIGHT=35 SRC="http://www.pals.iastate.edu/icons/fst_button.gif" ALT="++"></A><BR> 
        <HR WIDTH="70%" SIZE=2>
                      
        <FONT SIZE=-1 COLOR="#3300CC">Advance One:</FONT><BR>
                      <A HREF="JavaScript: func()" onClick="decrementImage(--current_image)"><IMG BORDER=0
WIDTH=35 HEIGHT=35 SRC="http://www.pals.iastate.edu/icons/mns_button.gif" ALT="-1"></A>
                      <A HREF="JavaScript: func()" onClick="incrementImage(++current_image)"><IMG BORDER=0
WIDTH=35 HEIGHT=35 SRC="http://www.pals.iastate.edu/icons/pls_button.gif" ALT="+1"></A>

        <HR WIDTH="70%" SIZE=2>
                      
                   </TD>
                   <TD BGCOLOR="#AAAAAA" ALIGN=CENTER VALIGN=MIDDLE>
                      <IMG NAME="animation" BORDER=0 SRC="<?php echo($site . "_". $product); ?>_9.gif" ALT="IEM Mesonet">
                   </TD>
               </TR>
             </TABLE>
