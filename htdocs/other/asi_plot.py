...
def main():
    ...
    ax[0].plot(valid, data['ch1avg'], linewidth=2, color='r', zorder=2,
               label='48.5m')
    ax[0].plot(valid, data['ch3avg'], linewidth=2, color='purple', zorder=2,
               label='32m')
    ax[0].plot(valid, data['ch5avg'], linewidth=2, color='black', zorder=2,
               label='10m')
    ...
    ax[0].set_title("ISUASI Station: %s Timeseries" % (
        nt.sts[station]['name'],))
