...
var gDocTable = new Array(
   ...
   new hrefList("slide0034.htm", 1, 22),
   new hrefList("slide0035.htm", 1, 23),
   new hrefList("slide0025.htm", 1, 24),
   new hrefList("slide0022.htm", 1, 25),
   new hrefList("slide0023.htm", 1, 26),
   new hrefList("slide0024.htm", 1, 27),
   new hrefList("slide0026.htm", 1, 28),
   new hrefList("slide0027.htm", 1, 29),
   new hrefList("slide0028.htm", 1, 30),
   new hrefList("slide0029.htm", 1, 31),
   new hrefList("slide0009.htm", 1, 32)
);
