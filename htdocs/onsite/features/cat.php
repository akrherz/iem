...
<fb:comments callback=\"$rooturl/fbcb.php\" title="<?php echo $row["title"]; ?>" url="<?php echo $rooturl; ?>/onsite/features/cat.php?day=<?php echo $day; ?>" xid="<?php echo $row["fbid"]; ?>" numposts="6" width="600"></fb:comments>
