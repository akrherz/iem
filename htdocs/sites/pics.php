...
$table = sprintf(
    ...
    printtd($network, "NW", $dir, $station),
    printtd($network, "N", $dir, $station),
    printtd($network, "NE", $dir, $station),
    printtd($network, "W", $dir, $station),
    "<td><img src=\"{$puri}\" alt=\"{$station} {$dir}\" class=\"img img-responsive\" /></td>",
    printtd($network, "E", $dir, $station),
    printtd($network, "SW", $dir, $station),
    printtd($network, "S", $dir, $station),
    printtd($network, "SE", $dir, $station)
);
