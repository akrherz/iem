...
def make_plot(station1, station2, mc, mckey):
...
def main():
    ...
    mckey = "/cgi-bin/climate/daily.py|%s|%s" % (station1, station2)
    ...
    if res:
        ...
        sys.stdout.write( make_plot(station1, station2, mc, mckey) )
